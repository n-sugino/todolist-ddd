...
class TodoController extends Controller
{
  /**
   *
   * @param TodoGetInfoServiceInterface $interactor
   * @return void
   */
    public function __invoke(TodoGetInfoServiceInterface $interactor)
    {
        $command = new TodoGetInfoCommand();
        $todos = $interactor->handle($command);
